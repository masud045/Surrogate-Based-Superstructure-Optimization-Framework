...
FNG_range = [100, 120]; %kmol/h
FH2O_range = [310, 375]; %kmol/h
Tsr_range = [1000, 1100]; %C
Psr_range = [38.2, 46.8]; %atm
...
save('datasets2_smr_fng_fh2o_Tsr_Psr.mat', 'all_FNG_samples', 'all_FH2O_samples','all_Tsr_samples', 'all_Psr_samples', 'all_xh2', 'all_f', 'net_energy');
